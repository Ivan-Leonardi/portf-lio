    ...
    <div name='sobre' className='w-full h-screen bg-[#06050c] text-gray-300 bg-[url(./assets/star.svg)] bg-cover sm:my-4 my-40'>
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
              ...
              data-aos-duration="1000" className='sm:text-right pb-8 pl-4 mt-24'>
                <p className='text-2xl sm:text-3xl font-bold inline border-b-2 border-blue-500'>Navegando Rumo ao Sucesso:</p>
              </div> 
              <div></div>
            </div> 

              <div data-aos="flip-down" data-aos-delay="500" data-aos-easing="linear"
               data-aos-duration="1000" className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
